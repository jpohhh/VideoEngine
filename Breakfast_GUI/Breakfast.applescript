...
on will finish launching theObject
	...
	tell user defaults
		...
		make new default entry at end of default entries with properties {name:"WatchFolder", contents:missing value}
		make new default entry at end of default entries with properties {name:"AddedItems", contents:missing value}
		...
		make new default entry at end of default entries with properties {name:"Tags.Season", contents:"missing"}
		make new default entry at end of default entries with properties {name:"Tags.Episode", contents:"missing"}
		make new default entry at end of default entries with properties {name:"Tags.Aired", contents:"missing"}
		make new default entry at end of default entries with properties {name:"Tags.cnid", contents:"missing"}
	...
	tell user defaults
		...
		set AddedItems to contents of default entry "AddedItems"
