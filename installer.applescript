...
do shell script "cd " & (the POSIX path of engineFolder) & "; osacompile -o BIN/ignition.scpt ignition.applescript; cp detail.sh $HOME/Library/Application\\ Support/Engine/; cp engine.sh $HOME/Library/Application\\ Support/Engine/; cd BIN cp HandbrakeCLI $HOME/Library/Application\\ Support/Engine/; cp mp4art $HOME/Library/Application\\ Support/Engine/; cp mp4tags $HOME/Library/Application\\ Support/Engine; cp mp4track $HOME/Library/Application\\ Support/Engine; cp ignition.scpt $HOME/Library/Scripts/Folder\\ Action\\ Scripts/; cp HandBrakeCLI $HOME/Library/Application\\ Support/Engine"
